...
<Image src="/screenshots/v0.2.0/crons-triggers.png" alt="Automation editor showing the trigger type dropdown with all nine trigger types" width={900} height={580} />

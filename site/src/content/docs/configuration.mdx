...
**Not yet handled: restacking.** When a blocker merges, branches stacked on it
are not automatically rebased onto the new base. Until that lands, treat
stacked branches as needing a manual rebase after their blocker merges.
